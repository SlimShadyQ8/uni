...
ConfigTriggers.BlackListedEvents = { -- ترقرات الممنوعه
	"8321hiue89js",
	"adminmenu:allowall",
	"AdminMenu:giveBank",
	"AdminMenu:giveCash",
	...
	"qb-admin:server:gotoTp",
	"qb-police:server:show:machine",
	"qb-bossmenu:server:openMenu",
	"qb-phone:server:sendNewMail",
	"qb-police:server:cuff:closest",
	"qb-police:server:set:handcuff:status",
	"qb-police:server:send:call:alert",
	"qb-hospital:server:heal:player",
	"qb-hospital:server:revive:player",
	"gcPhone:sendMessage",
